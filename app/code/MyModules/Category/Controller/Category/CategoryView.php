 ...
 */
class CategoryView extends Action implements HttpGetActionInterface, HttpPostActionInterface
{
    /**
     * Core registry
     *
    ...
    public function execute()
    {
        ...
        if ($category) {
            ...
            if(!empty($this->customerSession->getAllowedCategories())){
           
            	if(in_array($category->getId(), $this->customerSession->getAllowedCategories())){
                ...
                return $page;
            	 ...
            	 $this->_redirect('frontcategory/category/categorynotallowed');
            }
         }
