    ...
    public function prepareDataSource(array $dataSource)
    {
        if (isset($dataSource['data']['items'])) {
            foreach ($dataSource['data']['items'] as &$items) {
                // $items['remaining_credit_limit'] is column name
                
//              $items['remaining_credit_limit'] = $this->_storeManager->getStore()->getBaseCurrencyCode().' '.$items['remaining_credit_limit'];
                $items['remaining_credit_limit'] = $this->getFormatedCredit($items['remaining_credit_limit']);
            }
        }
        return $dataSource;
    }
