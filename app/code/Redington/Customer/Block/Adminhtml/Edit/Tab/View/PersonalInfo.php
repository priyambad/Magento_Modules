...
namespace Redington\Customer\Block\Adminhtml\Edit\Tab\View;
...
class PersonalInfo extends \Magento\Customer\Block\Adminhtml\Edit\Tab\View\PersonalInfo
{
    ...
    public function __construct(
		...
		$this->setTemplate('Magento_Customer::tab/view/personal_info.phtml');
    }
    ...
    public function getBillingAddressHtml()
    {
		...
		$street = $address->getStreet();
			...
			echo $address->getCity().', '.$address->getPostcode().'<br>';
			echo $this->getCountryname($address->getCountryId()).'<br>';
			echo 'T: <a href="tel:' .$address->getTelephone().'">' .$address->getTelephone().'</a>';
